...
export default function Logo() {
    return (
        <Link
            to="/"
            className="flex flex-1 items-center justify-center ml-20"
            aria-label="Logo"
        >
            ...
            <h2 className="mx-2 font-bold text-xl hover:text-green-700 dark:hover:text-gray-200 dark:text-white">SizlandERP </h2>
            <div className="inline-flex items-center rounded-full border font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 my-auto w-max px-2 py-0.5 text-xs text-green-700 dark:border-none dark:bg-green-800 dark:text-white">
                        FREE
                    </div>
        </Link>
    );
